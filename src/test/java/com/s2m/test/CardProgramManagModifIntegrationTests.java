...
public class CardProgramManagModifIntegrationTests {
 ...
 @Test
  public void testCardProgramManagModifIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("ListeCardForm:idIdenValid")).sendKeys("12");
