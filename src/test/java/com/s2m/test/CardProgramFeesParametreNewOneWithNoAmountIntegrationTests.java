...
public class CardProgramFeesParametreNewOneWithNoAmountIntegrationTests {
 ...
 @Test
  public void testCardProgramFeesParametreNewOneWithNoAmountIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputIdlll")).sendKeys("id1");
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputLabelll")).clear();
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputLabelll")).sendKeys("nom1");
    new Select(driver.findElement(By.id("globalChldCardParameterFeesForm:Lang"))).selectByVisibleText("test jkc2");
    driver.findElement(By.id("globalChldCardParameterFeesForm:j_id193:1")).click();
