...
public class CardProgramManagDeletIntegrationTests {
 ...
 //@Test
  public void testCardProgramManagDeletIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("ListeCardForm:idIdenValid")).sendKeys("122");
    driver.findElement(By.id("ListeCardForm:laaaaaaaabe")).clear();
    driver.findElement(By.id("ListeCardForm:laaaaaaaabe")).sendKeys("nom");
