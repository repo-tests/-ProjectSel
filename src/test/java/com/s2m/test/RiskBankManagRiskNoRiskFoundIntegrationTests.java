...
public class RiskBankManagRiskNoRiskFoundIntegrationTests {
  ...
  @Test
  public void testRiskBankManagRiskNoRiskFoundIntegrationTests() throws Exception {
    ...
    new Select(driver.findElement(By.id("globalIssuerRiskBankManagementForm:titletttrrrr"))).selectByVisibleText("banque tek test");
    driver.findElement(By.id("globalIssuerRiskBankManagementForm:hs5414")).click();
    new Select(driver.findElement(By.id("globalIssuerRiskBankManagementForm:titletttrrrr"))).selectByVisibleText("OBZA Bank");
    driver.findElement(By.id("globalIssuerRiskBankManagementForm:hs5414")).click();
