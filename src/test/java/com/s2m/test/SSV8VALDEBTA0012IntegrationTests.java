...
public class SSV8VALDEBTA0012IntegrationTests {
...
private  WebElement findElement( final By locator) {
 ...
 // @Test
  public void testSSV8VALDEBTA0012IntegrationTests() throws Exception {
    ...
    findElement(By.id("globalDebitProgramInquiryForm:dprIden")).sendKeys("iddd");
    Thread.sleep(1000); findElement(By.id("globalDebitProgramInquiryForm:dprLabe")).clear();
    findElement(By.id("globalDebitProgramInquiryForm:dprLabe")).sendKeys("labbbel");
