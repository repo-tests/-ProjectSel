...
findElement(By.id("j_username")).sendKeys("usercenter");
    ...
    findElement(By.xpath("//a[@onclick=\"if(typeof jsfcljs == 'function'){jsfcljs(document.getElementById('AddInquiryIssuerRiskBankManagementForm'),{'AddInquiryIssuerRiskBankManagementForm:j_id222':'AddInquiryIssuerRiskBankManagementForm:j_id222'},'');}return false\"]")).click();
    new Select(findElement(By.id("AddInquiryIssuerRiskBankManagementForm:bank111222111"))).selectByVisibleText("banque test 1");
    Thread.sleep(1000);
    Thread.sleep(1000); findElement(By.id("AddInquiryIssuerRiskBankManagementForm:idgfdgfdg222111")).clear();
