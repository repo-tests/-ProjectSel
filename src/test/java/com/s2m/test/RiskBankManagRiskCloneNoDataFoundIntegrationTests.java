...
public class RiskBankManagRiskCloneNoDataFoundIntegrationTests {
...
@Test
  public void testRiskBankManagRiskCloneNoDataFoundIntegrationTests() throws Exception {
    ...
    new Select(driver.findElement(By.id("globalIssuerRiskBankManagementForm:titletttrrrr"))).selectByVisibleText("Pole Edition Bank");
