...
public class SSV8VALDEBTA897IntegrationTests {
...
//*** supression des données du test de creation des motifs de remplacemnt
  //@Test
  public void testSSV8VALDEBTA897IntegrationTests() throws Exception {
    ...
    findElement(By.id("globalCardReplacementMotifForm:searchCardDesignFeesResultsId:0:sxqshxsqhxbkqsbxjsqbxeeee")).click();
    findElement(By.id("globalCardReplacementMotifForm:fdfdfdfdfdfeeeeeopp11117711144")).click();
    findElement(By.id("globalCardReplacementMotifForm:searchCardDesignFeesResultsId:0:sxqshxsqhxbkqsbxjsqbxeeee")).click();
    findElement(By.id("globalCardReplacementMotifForm:fdfdfdfdfdfeeeeeopp11117711144")).click();
    findElement(By.id("globalCardReplacementMotifForm:searchCardDesignFeesResultsId:0:sxqshxsqhxbkqsbxjsqbxeeee")).click();
    findElement(By.id("globalCardReplacementMotifForm:fdfdfdfdfdfeeeeeopp11117711144")).click();
