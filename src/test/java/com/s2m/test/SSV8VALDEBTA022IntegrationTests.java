...
public class SSV8VALDEBTA022IntegrationTests {
...
@Test
  public void testSSV8VALDEBTA022aIntegrationTests() throws Exception {
    ...
    findElement(By.id("ListeTransactionForm:j_id368_lbl")).click();
    findElement(By.id("ListeTransactionForm:j_id344_lbl")).click();
    findElement(By.id("ListeTransactionForm:j_id344_lbl")).click();
    findElement(By.id("ListeTransactionForm:j_id397_lbl")).click();
    Thread.sleep(1000); findElement(By.id("ListeTransactionForm:label")).clear();
    findElement(By.id("ListeTransactionForm:label")).sendKeys("Control_011V2");
    ...
    findElement(By.id("ListeTransactionForm:j_id392_lbl")).click();
    findElement(By.cssSelector("div.rich-list-picklist-button")).click();
    findElement(By.cssSelector("img[alt=\"save2\"]")).click();
    findElement(By.xpath("//div[2]/span/a")).click();
