...
public class CardProgramNewWithEmbossingDataDetailsIntegrationTests {
 ...
 //@Test
  public void testCardProgramNewWithEmbossingDataDetailsIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("ListeCardForm:idIdenValid")).sendKeys("id5");
    driver.findElement(By.id("ListeCardForm:laaaaaaaabe")).clear();
    driver.findElement(By.id("ListeCardForm:laaaaaaaabe")).sendKeys("nom5");
 ...
 //   new Select(driver.findElement(By.id("ListeCardForm:cardProgramControlItemsId"))).selectByVisibleText("Controles Produit Fusion");
    ...
    new Select(driver.findElement(By.id("ListeCardForm:inputLineFormat1"))).selectByVisibleText("Card Number");
    new Select(driver.findElement(By.id("ListeCardForm:inputLineFormat2"))).selectByVisibleText("Corporate Name");
    new Select(driver.findElement(By.id("ListeCardForm:inputLineFormat3"))).selectByVisibleText("Corporate Name");
    new Select(driver.findElement(By.id("ListeCardForm:inputLineFormat4"))).selectByVisibleText("Expiry Date Format1 (YYYY MM/YY)");
    new Select(driver.findElement(By.id("ListeCardForm:inputLineFormat5"))).selectByVisibleText("Expiry Date Format3 ( MM/YY)");
