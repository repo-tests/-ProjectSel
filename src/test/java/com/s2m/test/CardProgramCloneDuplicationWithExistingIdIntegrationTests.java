...
public class CardProgramCloneDuplicationWithExistingIdIntegrationTests {
 ...
 @Test
  public void testCardProgramCloneDuplicationWithExistingIdIntegrationTests() throws Exception {
   ...
   // new Select(driver.findElement(By.id("ListeCardForm:cardProgramControlItemsId"))).selectByVisibleText("Controles Produit Fusion");
    ...
    driver.findElement(By.id("j_id419:cprIden")).sendKeys("id2");
    driver.findElement(By.cssSelector("img[alt=\"save2\"]")).click();
    driver.findElement(By.xpath("(//img[@alt='save2'])[2]")).click();
    driver.findElement(By.xpath("//a[@id='ListeTransactionForm:searchResultsId:0:colne_command']/img")).click();
    driver.findElement(By.id("j_id419:cprIden")).clear();
    driver.findElement(By.id("j_id419:cprIden")).sendKeys("id3");
    driver.findElement(By.cssSelector("img[alt=\"save2\"]")).click();
    driver.findElement(By.cssSelector("img[alt=\"save2\"]")).click();
