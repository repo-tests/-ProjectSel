...
public class RiskBankManagRiskOnlyConsultIntegrationTests {
  ...
  @Test
  public void testRiskBankManagRiskOnlyConsultIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("globalIssuerRiskBankManagementForm:SearchCustChldOnliRiskRecoDetailPanel111222333:1:hfjdkhfjksdhfkjuzye2233332")).click();
