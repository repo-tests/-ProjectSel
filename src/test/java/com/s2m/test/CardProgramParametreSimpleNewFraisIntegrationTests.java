...
public class CardProgramParametreSimpleNewFraisIntegrationTests {
 ...
 @Test
  public void testCardProgramParametreSimpleNewFraisIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputAmoulll")).sendKeys("1000");
