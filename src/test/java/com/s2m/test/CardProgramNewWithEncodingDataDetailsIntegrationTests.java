...
public class CardProgramNewWithEncodingDataDetailsIntegrationTests {
  ...
  @Test
  public void testCardProgramNewWithEncodingDataDetailsIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("ListeCardForm:idIdenValid")).sendKeys("id7");
   ...
   // new Select(driver.findElement(By.id("ListeCardForm:cardProgramControlItemsId"))).selectByVisibleText("Controles Produit Fusion");
    ...
    driver.findElement(By.name("ListeCardForm:j_id410")).click();
    driver.findElement(By.id("ListeCardForm:idIdenValid")).clear();
    driver.findElement(By.id("ListeCardForm:idIdenValid")).sendKeys("id7");
    driver.findElement(By.id("ListeCardForm:laaaaaaaabe")).clear();
    driver.findElement(By.id("ListeCardForm:laaaaaaaabe")).sendKeys("nom7");
    new Select(driver.findElement(By.id("ListeCardForm:encTrac1Id"))).selectByVisibleText("Format A");
    new Select(driver.findElement(By.id("ListeCardForm:enTrac2Id"))).selectByVisibleText("Format B");
    new Select(driver.findElement(By.id("ListeCardForm:encTrac3Id"))).selectByVisibleText("Format JORDAN");
