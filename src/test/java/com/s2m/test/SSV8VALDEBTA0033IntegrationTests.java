...
public class SSV8VALDEBTA0033IntegrationTests {
...
private  WebElement findElement( final By locator) {
  ...
  //@Test
  public void testSSV8VALDEBTA0033IntegrationTests() throws Exception {
    ...
    findElement(By.id("globalDebitProgramInquiryForm:dprExpiDateDayCell15")).click();
