...
public class CardProgramNewRemplacementFeesWithNoAmountIntegrationTests {
  ...
  //@Test
  public void testCardProgramNewRemplacementFeesWithNoAmountIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("globalChldCardReplacementFeesForm:inputIdlll")).sendKeys("id100");
    driver.findElement(By.id("globalChldCardReplacementFeesForm:inputLabelll")).clear();
    driver.findElement(By.id("globalChldCardReplacementFeesForm:inputLabelll")).sendKeys("nom100");
