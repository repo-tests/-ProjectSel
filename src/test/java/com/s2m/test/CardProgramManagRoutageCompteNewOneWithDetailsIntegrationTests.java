...
public class CardProgramManagRoutageCompteNewOneWithDetailsIntegrationTests {
 ...
 // @Test
  public void testCardProgramManagRoutageCompteNewOneWithDetailsIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("ListeProfileAccountRoutingForm:yyy")).sendKeys("Lib1");
    driver.findElement(By.id("ListeProfileAccountRoutingForm:checkSta1")).click();
    driver.findElement(By.id("ListeProfileAccountRoutingForm:checkSta4")).click();
    driver.findElement(By.id("ListeProfileAccountRoutingForm:checkSta2")).click();
    driver.findElement(By.id("ListeProfileAccountRoutingForm:checkSta5")).click();
    driver.findElement(By.id("ListeProfileAccountRoutingForm:checkSta3")).click();
