...
public class CardProgramCloneSimpleDuplicationIntegrationTests {
  ...
  @Test
  public void testCardProgramCloneSimpleDuplicationIntegrationTests() throws Exception {
  ...
  // new Select(driver.findElement(By.id("ListeCardForm:cardProgramControlItemsId"))).selectByVisibleText("Controles Produit Fusion");
    ...
    driver.findElement(By.id("j_id419:cprIden")).sendKeys("idc22");
    driver.findElement(By.cssSelector("img[alt=\"save2\"]")).click();
    driver.findElement(By.cssSelector("img[alt=\"save2\"]")).click();
