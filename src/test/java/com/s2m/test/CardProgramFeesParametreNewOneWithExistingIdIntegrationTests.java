...
public class CardProgramFeesParametreNewOneWithExistingIdIntegrationTests {
 ...
 // @Test
  public void testCardProgramFeesParametreNewOneWithExistingIdIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputIdlll")).sendKeys("idExistant");
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputLabelll")).clear();
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputLabelll")).sendKeys("nomNon");
    new Select(driver.findElement(By.id("globalChldCardParameterFeesForm:Lang"))).selectByVisibleText("test jkc");
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputAmoulll")).clear();
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputAmoulll")).sendKeys("100");
    ...
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputIdlll")).sendKeys("IdExistant");
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputLabelll")).clear();
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputLabelll")).sendKeys("nomoui");
    new Select(driver.findElement(By.id("globalChldCardParameterFeesForm:Lang"))).selectByVisibleText("test jkc");
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputAmoulll")).clear();
    driver.findElement(By.id("globalChldCardParameterFeesForm:inputAmoulll")).sendKeys("100");
    driver.findElement(By.cssSelector("img[alt=\"save2\"]")).click();
    ...
    driver.findElement(By.xpath("//span[@id='globalChldCardParameterFeesForm:searchParameterFeesResultsId:1:j_id248']/a/img")).click();
