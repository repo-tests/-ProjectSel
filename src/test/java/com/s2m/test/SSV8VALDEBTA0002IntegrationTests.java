...
findElement(By.id("j_username")).sendKeys("usercenter");
    ...
    findElement(By.xpath("//a[@onclick=\"if(typeof jsfcljs == 'function'){jsfcljs(document.getElementById('MyBranchForm'),{'MyBranchForm:j_id640':'MyBranchForm:j_id640'},'');}return false\"]")).click();
    findElement(By.linkText("New Branch")).click();
