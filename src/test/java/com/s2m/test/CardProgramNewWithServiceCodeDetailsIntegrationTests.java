...
public class CardProgramNewWithServiceCodeDetailsIntegrationTests {
...
@Test
  public void testCardProgramNewWithServiceCodeDetailsIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("ListeCardForm:idIdenValid")).sendKeys("id3");
    driver.findElement(By.id("ListeCardForm:laaaaaaaabe")).clear();
    driver.findElement(By.id("ListeCardForm:laaaaaaaabe")).sendKeys("nom3");
    ...
    new Select(driver.findElement(By.id("ListeCardForm:serviceCode3"))).selectByVisibleText("2 - sco_lab3");
