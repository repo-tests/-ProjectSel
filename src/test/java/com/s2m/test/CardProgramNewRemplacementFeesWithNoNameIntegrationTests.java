...
public class CardProgramNewRemplacementFeesWithNoNameIntegrationTests {
 ...
 // @Test
  public void testCardProgramNewRemplacementFeesWithNoNameIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("globalChldCardReplacementFeesForm:inputIdlll")).sendKeys("id10");
