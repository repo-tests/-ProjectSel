...
public class CardProgramNewWithCardProgramDetailsIntegrationTests {
  ...
  @Test
  public void testCardProgramNewWithCardProgramDetailsIntegrationTests() throws Exception {
    ...
    driver.findElement(By.id("ListeCardForm:idIdenValid")).sendKeys("id2");
    driver.findElement(By.id("ListeCardForm:laaaaaaaabe")).clear();
    driver.findElement(By.id("ListeCardForm:laaaaaaaabe")).sendKeys("nom2");
  ...
  //  new Select(driver.findElement(By.id("ListeCardForm:cardProgramControlItemsId"))).selectByVisibleText("Controles Produit Fusion");
    ...
    driver.findElement(By.id("ListeCardForm:idCprPrepDate")).sendKeys("10");
    driver.findElement(By.id("ListeCardForm:pinTryLimit")).clear();
    driver.findElement(By.id("ListeCardForm:pinTryLimit")).sendKeys("10");
    driver.findElement(By.id("ListeCardForm:AZD11he")).click();
    driver.findElement(By.id("ListeCardForm:AZD11hs")).click();
    driver.findElement(By.id("ListeCardForm:AZD11bbkkv")).click();
    driver.findElement(By.id("ListeCardForm:AZD11hf")).click();
    driver.findElement(By.id("ListeCardForm:AZD11hfj")).click();
